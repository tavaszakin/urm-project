...
async function renderSelection() {
  ...
  try {
    ...
    const comparisonSource = liveProduction
      ? "native production SketchV4 Layer E"
    ...
    renderCard($("#candidate-card"), liveProduction ? "Live production Layer E" : "Current harness reproduction", candidate, candidateFocus, diff, {
